...
public interface WeatherSoap {
     ...
     * 
     * @return
     *     returns pl.szkolenie.ws.ArrayOfWeatherDescription
     */
    ...
    @RequestWrapper(localName = "GetWeatherInformation", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "pl.szkolenie.ws.GetWeatherInformation")
    @ResponseWrapper(localName = "GetWeatherInformationResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "pl.szkolenie.ws.GetWeatherInformationResponse")
     ...
     * @param zip
     * @return
     *     returns pl.szkolenie.ws.ForecastReturn
     */
    ...
    @RequestWrapper(localName = "GetCityForecastByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "pl.szkolenie.ws.GetCityForecastByZIP")
    @ResponseWrapper(localName = "GetCityForecastByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "pl.szkolenie.ws.GetCityForecastByZIPResponse")
     ...
     * @param zip
     * @return
     *     returns pl.szkolenie.ws.WeatherReturn
     */
    ...
    @RequestWrapper(localName = "GetCityWeatherByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "pl.szkolenie.ws.GetCityWeatherByZIP")
    @ResponseWrapper(localName = "GetCityWeatherByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "pl.szkolenie.ws.GetCityWeatherByZIPResponse")
